...
> **Status: released and in everyday use.** Partitions, the electric fence, PGM outputs and zone
> bypass all work; so do per-zone wireless health and the action layer. Reading and writing the
> panel's full programming is still to come. Issues and pull requests are welcome.
